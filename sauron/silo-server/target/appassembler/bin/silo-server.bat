...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="silo-server" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.sauron.silo.SiloServerApp %CMD_LINE_ARGS%
