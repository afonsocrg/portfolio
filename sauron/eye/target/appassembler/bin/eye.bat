...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="eye" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.sauron.eye.EyeApp %CMD_LINE_ARGS%
