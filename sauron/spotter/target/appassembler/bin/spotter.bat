...
%JAVACMD% %JAVA_OPTS%  -classpath %CLASSPATH% -Dapp.name="spotter" -Dapp.repo="%REPO%" -Dapp.home="%BASEDIR%" -Dbasedir="%BASEDIR%" pt.tecnico.sauron.spotter.SpotterApp %CMD_LINE_ARGS%
